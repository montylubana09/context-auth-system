...
export default function Dashboard() {
  ...
  const RiskAssessmentBar = ({
    ...
    const calculateRiskScore = () => {
      ...
      // } else {
      //   score += 5; // Normal risk for production
